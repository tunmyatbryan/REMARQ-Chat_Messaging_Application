...
/*
This function will receive USERNAME.txt file which is sent throught socket.
It will read and write the file. Return 1 if there is an error. Return 0 if receive successfully.
It will write the file name "USERNAME_Client.txt".
...
int receive_UserNametxt(int socket)
{ 
	FILE *file;
